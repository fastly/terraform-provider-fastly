			...
			remote: []*gofastly.Backend{
				{
					...
					Address:             new("www.notexample.com"),
					...
					KeepAliveTime:       new(1500),
					MaxConn:             new(200),
					MaxLifetime:         new(30000),
					MaxUse:              new(10),
					...
					MaxTLSVersion:       new(""),
					MinTLSVersion:       new(""),
					SSLCiphers:          new("foo:bar:baz"),
					Shield:              new("lga-ny-us"),
					Weight:              new(100),
				},
			},
			local: []map[string]any{
...
func TestAccFastlyServiceVCLBackend_basic(t *testing.T) {
	...
	b3 := gofastly.Backend{
		Address: new(backendAddress),
		Name:    new(backendName + " new with use ssl"),
		...
		Port:            new(80),
		SSLCertHostname: new("httpbin.org"),
		UseSSL:          new(true),
