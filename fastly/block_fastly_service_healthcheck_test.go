			...
			remote: []*gofastly.HealthCheck{
				{
					...
					Name:             new("myhealthcheck"),
					Headers:          []string{"Foo: Bar", "Baz: Qux"},
					Host:             new("example1.com"),
					Path:             new("/test1.txt"),
					CheckInterval:    new(4000),
					ExpectedResponse: new(200),
					HTTPVersion:      new("1.1"),
					Initial:          new(2),
					Method:           new("HEAD"),
					Threshold:        new(3),
...
func TestAccFastlyServiceVCL_healthcheck_basic(t *testing.T) {
	...
	log2 := gofastly.HealthCheck{
		CheckInterval:    new(4500),
		Comment:          new(""),
		ExpectedResponse: new(404),
		HTTPVersion:      new("1.0"),
		Headers:          []string{"Beep: Boop"},
		Host:             new("example2.com"),
		Initial:          new(1),
		Method:           new("POST"),
		Name:             new("example-healthcheck2"),
		Path:             new("/test2.txt"),
		ServiceVersion:   new(1),
		Threshold:        new(4),
		Timeout:          new(4000),
