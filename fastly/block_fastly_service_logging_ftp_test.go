...
func TestAccFastlyServiceLoggingFTP_vcl_basic(t *testing.T) {
	...
	log1 := gofastly.FTP{
		Address:           new("ftp.example.com"),
		CompressionCodec:  new("zstd"),
		Format:            new(LoggingFTPDefaultFormat),
		FormatVersion:     new(2),
		GzipLevel:         new(0),
		MessageType:       new("classic"),
		Name:              new("ftp-endpoint"),
	...
	log1AfterUpdate := gofastly.FTP{
		Address:           new("ftp2.example.com"),
		Format:            new(LoggingFormatUpdate),
		FormatVersion:     new(2),
		GzipLevel:         new(4),
		MessageType:       new("classic"),
		Name:              new("ftp-endpoint"),
		Password:          new("p@ssw0rd2"),
		Path:              new("/path"),
		Period:            new(3600),
		Placement:         new("none"),
		Port:              new(21),
