...
func TestAccFastlyServiceLoggingS3_vcl_basic(t *testing.T) {
	...
	log1 := gofastly.S3{
		ACL:                          new(gofastly.S3AccessControlList("")),
		AccessKey:                    new(testAwsPrimaryAccessKey),
		BucketName:                   new("fastlytestlogging"),
		CompressionCodec:             new("zstd"),
		Domain:                       new("s3-us-west-2.amazonaws.com"),
		FileMaxBytes:                 new(0),
		Format:                       new(LoggingS3DefaultFormat),
		FormatVersion:                new(2),
		GzipLevel:                    new(0),
		IAMRole:                      new(""),
		MessageType:                  new("classic"),
		Name:                         new("somebucketlog"),
		Path:                         new(""),
		Period:                       new(3600),
		PublicKey:                    new(pgpPublicKey(t)),
		Redundancy:                   new(gofastly.S3Redundancy("")),
		ResponseCondition:            new("response_condition_test"),
		SecretKey:                    new(testAwsPrimarySecretKey),
	...
	log1AfterUpdate := gofastly.S3{
		ACL:                          new(gofastly.S3AccessControlListAWSExecRead),
		AccessKey:                    new(""),
		BucketName:                   new("fastlytestlogging"),
		Domain:                       new("s3-us-west-2.amazonaws.com"),
		FileMaxBytes:                 new(0),
		...
		FormatVersion:                new(2),
		GzipLevel:                    new(3),
		IAMRole:                      new(testS3IAMRole),
		MessageType:                  new("blank"),
		Name:                         new("somebucketlog"),
		Path:                         new(""),
		Period:                       new(3600),
		PublicKey:                    new(pgpPublicKey(t)),
		Redundancy:                   new(gofastly.S3RedundancyReduced),
		ResponseCondition:            new("response_condition_test"),
		SecretKey:                    new(""),
		ServerSideEncryptionKMSKeyID: new(""),
		ServiceVersion:               new(1),
	...
	log2 := gofastly.S3{
		ACL:                          new(gofastly.S3AccessControlList("")),
		AccessKey:                    new(""),
		BucketName:                   new("fastlytestlogging2"),
		CompressionCodec:             new("zstd"),
		Domain:                       new("s3-us-west-2.amazonaws.com"),
		FileMaxBytes:                 new(0),
		Format:                       new(LoggingFormatUpdate),
			...
			remote: []*gofastly.S3{
				{
					...
					Format:                       new(LoggingS3DefaultFormat),
					FormatVersion:                new(2),
					GzipLevel:                    new(0), // API sets this as default if not passed in API request.
					MessageType:                  new("classic"),
					Name:                         new("s3-endpoint"),
					Path:                         new("/"),
					Period:                       new(3600),
					Placement:                    new("none"),
					PublicKey:                    new(pgpPublicKey(t)),
					...
					ResponseCondition:            new("response_condition_test"),
					SecretKey:                    new(testAwsPrimarySecretKey),
					ServerSideEncryption:         new(gofastly.S3ServerSideEncryptionAES),
			...
			remote: []*gofastly.S3{
				{
					...
					ServerSideEncryptionKMSKeyID: new("kmskey"),
					ServerSideEncryption:         new(gofastly.S3ServerSideEncryptionAES),
					ACL:                          new(gofastly.S3AccessControlListPrivate),
					FileMaxBytes:                 new(12345),
				},
			},
			local: []map[string]any{
				{
