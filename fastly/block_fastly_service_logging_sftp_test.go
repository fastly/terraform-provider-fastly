...
func TestAccFastlyServiceLoggingSFTP_vcl_basic(t *testing.T) {
	...
	log1 := gofastly.SFTP{
		Address:           new("sftp.example.com"),
		CompressionCodec:  new("zstd"),
		Format:            new(LoggingSFTPDefaultFormat),
		FormatVersion:     new(2),
		GzipLevel:         new(0),
		MessageType:       new("classic"),
		Name:              new("sftp-endpoint"),
		...
		SSHKnownHosts:     new("sftp.example.com"),
		SecretKey:         new(""),
	...
	log2 := gofastly.SFTP{
		Address:           new("sftp2.example.com"),
		CompressionCodec:  new("zstd"),
		Format:            new(LoggingFormatUpdate),
		FormatVersion:     new(2),
		GzipLevel:         new(0),
		MessageType:       new("loggly"),
		Name:              new("another-sftp-endpoint"),
		Password:          new(""),
		Path:              new("/dir/"),
		Period:            new(3600),
		Placement:         new("none"),
		...
		PublicKey:         new(pgpPublicKey(t)),
		ResponseCondition: new("response_condition_test"),
		SSHKnownHosts:     new("sftp2.example.com"),
		SecretKey:         new(privateKey(t)),
		ServiceVersion:    new(1),
		TimestampFormat:   new("%Y-%m-%dT%H:%M:%S.000"),
		User:              new("user"),
