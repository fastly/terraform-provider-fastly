		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_logging_splunk.test", "tls.ca_cert", "test-ca-cert"),
					resource.TestCheckResourceAttr("fastly_service_logging_splunk.test", "tls.client_cert", "test-client-cert"),
					resource.TestCheckResourceAttr("fastly_service_logging_splunk.test", "tls.client_key", "test-client-key"),
