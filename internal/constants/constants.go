...
// This mirrors the format the Fastly API assigns when none is sent - the API is
// the source of truth. TestAccFastlyServiceLoggingDatadog_formatDefault fails if
// they drift apart.
