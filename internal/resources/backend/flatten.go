...
func flatten(ctx context.Context, b *fastly.Backend, m *Model) {
	...
	m.Name = nested.Name
	m.Address = nested.Address
	m.Port = nested.Port
	m.Comment = nested.Comment
	m.AutoLoadbalance = nested.AutoLoadbalance
	m.BetweenBytesTimeout = nested.BetweenBytesTimeout
	m.ConnectTimeout = nested.ConnectTimeout
	m.ErrorThreshold = nested.ErrorThreshold
	m.FirstByteTimeout = nested.FirstByteTimeout
	m.HealthCheck = nested.HealthCheck
	m.KeepaliveTime = nested.KeepaliveTime
	m.MaxConn = nested.MaxConn
	m.MaxLifetime = nested.MaxLifetime
	m.MaxTLSVersion = nested.MaxTLSVersion
	m.MaxUse = nested.MaxUse
	m.MinTLSVersion = nested.MinTLSVersion
	m.OverrideHost = nested.OverrideHost
	m.PreferIPv6 = nested.PreferIPv6
	m.RequestCondition = nested.RequestCondition
	m.ShareKey = nested.ShareKey
	m.Shield = nested.Shield
	m.SSLCACert = nested.SSLCACert
	m.SSLCertHostname = nested.SSLCertHostname
	m.SSLCheckCert = nested.SSLCheckCert
	m.SSLCiphers = nested.SSLCiphers
	m.SSLClientCert = nested.SSLClientCert
	m.SSLClientKey = nested.SSLClientKey
	m.SSLSNIHostname = nested.SSLSNIHostname
	m.UseSSL = nested.UseSSL
	m.Weight = nested.Weight
