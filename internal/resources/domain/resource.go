...
func (r *Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err := validation.EnsureServiceTypeSupported(ctx, r.providerData.Client, plan.Service.ValueString(), "fastly_service_domain", service.TypeVCL, service.TypeCompute); err != nil {
...
func (r *Resource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err := validation.EnsureServiceTypeSupported(ctx, r.providerData.Client, state.Service.ValueString(), "fastly_service_domain", service.TypeVCL, service.TypeCompute); err != nil {
